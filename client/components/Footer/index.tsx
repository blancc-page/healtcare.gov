        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                Compare top insurance plans, check your eligibility for savings, and enroll with confidence — all in one place.
                </p>
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              Software Principles 2025© <br/>Group B.
            </p>
          </div>
        </div>
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#2b8774" stopOpacity="0.62" />
                <stop offset="1" stopColor="#2b8774" stopOpacity="0" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#2b8774" stopOpacity="0" />
                <stop offset="1" stopColor="#2b8774" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
